           ...
           for(int j=0 ; j < newwidth ; j++)
           {
	           ...
	           float deltawidth           = mappedwidth - OriginalPosWidth;   //delta c
	            ...
	            unsigned char * temp2 = pixel(Img, ((OriginalPosHeight + 1) >= height ? OriginalPosHeight : OriginalPosHeight + 1),
                    OriginalPosWidth , width , height , bpp);
	            unsigned char * temp3 = pixel(Img,OriginalPosHeight , OriginalPosWidth+1 , width , height , bpp);
	            unsigned char * temp4 = pixel(Img,((OriginalPosHeight+1)>=height? OriginalPosHeight: OriginalPosHeight + 1) ,
                    (OriginalPosWidth+1)>=width? OriginalPosWidth: (OriginalPosWidth + 1), width , height , bpp);
